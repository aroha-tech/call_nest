...
const TENANT_PATH_OVERRIDES = {
  ...
  '/settings/billing/history/payments': 'Payments & invoices',
  '/settings/billing/history/subscriptions': 'Subscription history',
  '/settings/billing/history/wallet': 'Wallet history',
...
const PLATFORM_PATH_OVERRIDES = {
  ...
  '/admin/telephony-plans': 'Product plans',
  '/admin/billing': 'Billing',
  '/admin/billing/tenant': 'Tenant billing',
  '/admin/telephony-plans/subscription/new': 'New subscription plan',
  '/admin/telephony-plans/top-up/new': 'New credit top-up',
  '/admin/telephony-plans/seat-plans/new': 'New seat add-on',
  '/admin/telephony-billing': 'Billing',
