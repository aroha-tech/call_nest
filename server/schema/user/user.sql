...
CREATE TABLE IF NOT EXISTS users (
  ...
  datetime_timezone VARCHAR(64) NOT NULL DEFAULT 'Asia/Kolkata',
  datetime_date_format ENUM('DD-MM-YYYY', 'DD/MM/YYYY', 'MM-DD-YYYY', 'MM/DD/YYYY', 'YYYY-MM-DD') NOT NULL DEFAULT 'DD-MM-YYYY',
  datetime_time_format ENUM('12h_with_seconds', '12h', '24h_with_seconds', '24h') NOT NULL DEFAULT '12h_with_seconds',
