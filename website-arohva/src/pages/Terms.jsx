...
export default function Terms() {
  ...
  return (
    <div className="page page--wide">
      ...
      <p>
        These Terms of Service (“Terms”) govern your access to and use of {saasProductName} and
      ...
      <h2>1. The Service</h2>
      <p>
        We provide {saasProductName} as described on our website and order forms. Features may
        differ
