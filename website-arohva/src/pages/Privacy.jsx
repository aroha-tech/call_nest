...
export default function Privacy() {
  const { saasProductName, companyLegalName, contactEmail, lastUpdatedPrivacy } = siteConfig;
  ...
  return (
    <div className="page page--wide">
      ...
      <p>
        ...
        and shares information when you visit this website or use {saasProductName} (the
        “Service”).
      ...
      <p>
        ...
        Revoking access may limit certain features in {saasProductName}.
      </p>
